...
// console.log(ABI);
var address = "0x0B820e4c13d75Cfa37DD434E76168bfdB4a3737F";
// console.log(address);
var capability = web3.eth.contract(ABI).at(address);
// console.log(smartKey);
capability.delegation.sendTransaction(web3.eth.accounts[1], "read", true, true, {from: web3.eth.accounts[0], gas:3000000});
