  ...
  .then(function(){
    ...
    .once('confirmation', (confirmationNumber, receipt) => {
      ...
      .once('confirmation', (confirmationNumber, receipt) => {
        ...
        myContract.methods.singleRevocation(accounts[1], "read1").send({from: accounts[0], gasPrice: gasPrice, gas: 8000000})
        .once('confirmation', (confirmationNumber, receipt) => {
          console.log("gas_singleRevocationP1:",receipt.gasUsed);
        });
      });
    });
  });
    ...
    .once('confirmation', (confirmationNumber, receipt) => {
      ...
      .once('confirmation', (confirmationNumber, receipt) => {
        ...
        .once('confirmation', (confirmationNumber, receipt) => {
          ...
          myContract.methods.singleRevocation(accounts[1], "read2").send({from: accounts[0], gasPrice: gasPrice, gas: 8000000})
          .once('confirmation', (confirmationNumber, receipt) => {
            console.log("gas_singleRevocationP2:",receipt.gasUsed);
          });
        });
      });
    });
    ...
    .once('confirmation', (confirmationNumber, receipt) => {
      ...
      .once('confirmation', (confirmationNumber, receipt) => {
        ...
        .once('confirmation', (confirmationNumber, receipt) => {
          ...
          myContract.methods.singleRevocation(accounts[1], "read3").send({from: accounts[0], gasPrice: gasPrice, gas: 8000000})
          .once('confirmation', (confirmationNumber, receipt) => {
            console.log("gas_singleRevocationP3:",receipt.gasUsed);
          });
          });
        });
      });
        ...
        .once('confirmation', (confirmationNumber, receipt) => {
          ...
          .once('confirmation', (confirmationNumber, receipt) => {
            ...
            .once('confirmation', (confirmationNumber, receipt) => {
              ...
              myContract.methods.singleRevocation(accounts[1], "read4").send({from: accounts[0], gasPrice: gasPrice, gas: 8000000})
              .once('confirmation', (confirmationNumber, receipt) => {
                console.log("gas_singleRevocationP4:",receipt.gasUsed);
              });
            });
          });
        });
          ...
          .once('confirmation', (confirmationNumber, receipt) => {
            ...
            .once('confirmation', (confirmationNumber, receipt) => {
              ...
              .once('confirmation', (confirmationNumber, receipt) => {
                ...
                myContract.methods.singleRevocation(accounts[1], "read5").send({from: accounts[0], gasPrice: gasPrice, gas: 8000000})
                .once('confirmation', (confirmationNumber, receipt) => {
                  console.log("gas_singleRevocationP5:",receipt.gasUsed);
                });
              });
            });
          });
