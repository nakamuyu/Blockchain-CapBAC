  ...
  .then(function(){
    ...
    .once('confirmation', (confirmationNumber, receipt) => {
      ...
      .once('confirmation', (confirmationNumber, receipt) => {
        ...
        myContract.methods.delegation(accounts[2], "read", true, true).send({from: accounts[1], gasPrice: gasPrice, gas: 8000000})
        .once('confirmation', (confirmationNumber, receipt) => {
          console.log("gas_delegateFrom1To2:",receipt.gasUsed);

          myContract.methods.delegation(accounts[4], "read", true, true).send({from: accounts[2], gasPrice: gasPrice, gas: 8000000})
          .once('confirmation', (confirmationNumber, receipt) => {
            console.log("gas_delegateFrom2To3:",receipt.gasUsed);

            myContract.methods.delegation(accounts[6], "read", true, true).send({from: accounts[2], gasPrice: gasPrice, gas: 8000000})
            .once('confirmation', (confirmationNumber, receipt) => {
              console.log("gas_delegateFrom2To4:",receipt.gasUsed);

              myContract.methods.delegation(accounts[7], "read", true, true).send({from: accounts[2], gasPrice: gasPrice, gas: 8000000})
              .once('confirmation', (confirmationNumber, receipt) => {
